        ...
        <div className="rounded-[28px] bg-white p-6 shadow-sm sm:p-8 lg:p-10">
          ...
          <div className="mb-8 border-b border-slate-200 pb-6">
            ...
            <h1 className="mt-3 text-3xl font-bold leading-tight text-[#0d3763] sm:text-4xl">
              Masjid Usang Koto Marapak, Warisan Sejarah dan Syiar Islam di
              Nagari Lambah
            </h1>
          ...
          <figure className="mb-10">
            <div className="overflow-hidden rounded-2xl bg-slate-100">
              <Image
                src="/image/masjid-usang-koto-marapak.jpg"
                alt="Masjid Usang Koto Marapak Nagari Lambah"
                width={1200}
                height={1600}
            ...
            <figcaption className="mt-3 text-center text-sm text-slate-500">
              Masjid Usang Koto Marapak, Nagari Lambah, Kecamatan Ampek Angkek.
            </figcaption>
          </figure>
